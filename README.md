...
Progress: 6 / 7
Completed modules: 4
Completed guided projects: 2
Next item: Trophy - Write Your First Code Using C#
...
| --- | ---: | --- |
| Curriculum items | 6 | In progress |
| Guided projects | 2 | In progress |
...
```text
Write Your First Code Using C#: 6 / 7
```
...
This is the final item in the
**Write Your First Code Using C#** section.

Completing the trophy will confirm completion of all four instructional modules
and both guided projects in the section.

After the trophy is completed, the repository will continue with:

```text
Create and Run Simple C# Console Applications
```

The next section is expected to introduce more structured console-application
development and build on the syntax, data types, operators, calculations, and
output-formatting skills documented here.
